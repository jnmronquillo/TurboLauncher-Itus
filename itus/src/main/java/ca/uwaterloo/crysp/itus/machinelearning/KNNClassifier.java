...
public class KNNClassifier extends Classifier {
	...
	//KNNModel previous position
	//Moved outside NotSerializableException because of parent class
	/**
	...
	public int classify(FeatureVector featureVector) 
		...
		Log.i("Log","data size "+model.data.size());
		Log.i("Log","numFeatures "+model.numFeatures);
		Log.i("Log","featureVector.size "+featureVector.size());
		for (FeatureVector fv : model.data) {
			...
			Log.i("Log "+fv.getClassLabel().getClassLabel(),mLog);
